...
int main() {
         ...
         *
         * VAR_SPEED: Makes the robot increase in speed, if false, the robot
         * either drives or doesnt VERBOSE: Prints output to the screen INSYNC:
         * Keeps the wii controller thread at the same rate as the serial thread
         * NONLIN: Non linear increase in speed, does nothing if var speed is
         * false DISCLINANG: Eitehr turns or drives. Can't do both DEBUG:
         * ignores serial port all together ADVNCD: If you press the + button on
         * the remote, you enter advanced, where you can change any of the above
        ...
        // Creates a thread (thread_obj, parameters, description, callback
        // function)
